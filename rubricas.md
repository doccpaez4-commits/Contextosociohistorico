...
<p class="lede">Structure of Observed Learning Outcomes — una rúbrica por actividad evaluada</p>
...
<p>Salud Internacional vs. Salud Global — implicaciones de la modernidad para la salud pública, usando la <a href="{{ '/herramientas/debate.html' | relative_url }}">herramienta de debate</a> del curso.</p>
<div class="weight-pill">Peso en la nota final <div class="bar"><i style="width:30%;"></i></div> 30%</div>
</div>
...
<p>Integra los aprendizajes de todo el curso. <strong>No se evalúa si la determinación social se aplica "correctamente"</strong>, sino si el estudiante logra <strong>romper el causalismo</strong>.</p>
<div class="weight-bar">
  <div class="w1" style="width:30%;">30%</div>
  <div class="w2" style="width:30%;">30%</div>
  <div class="w3" style="width:40%;">40%</div>
</div>
<div class="weight-legend">
  <span><span class="dot" style="background:var(--teal-500);"></span>Herramientas audiovisuales</span>
  <span><span class="dot" style="background:var(--teal-700);"></span>Expresión oral</span>
  <span><span class="dot" style="background:var(--amber);"></span>Coherencia analítica y ruptura del causalismo</span>
</div>
